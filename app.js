...
function setMobileView(view) {
  ...
  mobilePanels.forEach((panel) => {
    panel.classList.toggle("is-mobile-active", panel.dataset.mobilePanel === view);
  });
}
...
function render() {
  ...
  renderCart();
  renderOrders();
  setMobileView(state.mobileView || "menu");
}
...
mobileViewButtons.forEach((button) => {
  button.addEventListener("click", () => {
    state.mobileView = button.dataset.mobileViewButton;
